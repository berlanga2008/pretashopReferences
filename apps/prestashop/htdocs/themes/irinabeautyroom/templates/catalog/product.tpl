  ...
  <section id="main" itemscope itemtype="https://schema.org/Product">
    ...
    <div class="row">
      ...
      <div class="col-12 col-lg-6 content-wrap">
        ...
        {block name='product_quantities'}
          {if $product.show_quantities}
            <div class="product-quantities">
              ...
              <span id="quieroCambiarP2">{$product.quantity} {$product.quantity_label}</span>
            </div>
          {/if}
        {/block}
        ...
        {block name='product_reference'}
          {if isset($product.reference_to_display)}
            <div class="product-reference">
              ...
              <span id="quieroCambiar2" itemprop="sku">{$product.reference_to_display}</span>
            </div>
          {/if}
        {/block}
        ...
        <!-- aqui es donde estaba antes el class="additional-info" y su hook -->
      </div>
    </div>
        ...
        <div class="tabs col-12 col-lg-7">
          <ul class="nav nav-tabs" role="tablist">
            {if $product.description}
              <li class="nav-item">
                <a class="nav-link{if $product.description} active{/if}" data-toggle="tab" href="#description" role="tab" aria-controls="description" {if $product.description} aria-selected="true"{/if}>
                  {l s='Description' d='Shop.Theme.Catalog'}
                </a>
              </li>
            {/if}
            <li class="nav-item">
              <a class="nav-link{if !$product.description} active{/if}" data-toggle="tab" href="#product-details" role="tab" aria-controls="product-details" {if !$product.description} aria-selected="true"{/if}>
                  ...
                  <section class="product-attachments">
                    {foreach from=$product.attachments item=attachment}
                      <div class="attachment">
                        ...
                        <a class="btn btn-md btn-default" href="{url entity='attachment' params=['id_attachment' => $attachment.id_attachment]}">
